...
import registerResturant from './../../public/images/registerResturant.png'
import Modal from './Modal/ModalResturant'
                                ...
                                <div className="space-y-6 slideInLeft">
                                    <div className="text-lg lg:text-xl text-[var(--text-body)] leading-relaxed space-y-4">
                                        <p className="transform transition-all duration-300 hover:translate-x-2">
                                            {t('registerResturant.description1')}
                                        </p>
                                        <p className="transform transition-all duration-300 hover:translate-x-2">
                                            {t('registerResturant.description2')}
                                        </p>
                                        <p className="transform transition-all duration-300 hover:translate-x-2">
                                            {t('registerResturant.description3')}
                                        </p>
                                    </div>
                                </div>
